...
public class PivotDataCommand extends Command {

    //private ShuffleboardTab pivotTab = Shuffleboard.getTab("Pivot");

    private final PivotSubsystem pivotSubsystem;
    public PivotDataCommand(PivotSubsystem subsystem) {
    ...
    public void execute() {
        ...
        //pivotSubsystem.reachSetpoint(0.51); //0.48 vertical, 0.386 com at 0 rad
    }
